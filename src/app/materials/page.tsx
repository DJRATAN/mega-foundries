        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {metalCategories.map((item) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#cc2221] text-[15px] transition-colors">
                {item.title}
              </h3>

              <p className="text-gray-500 text-[11px] mb-6 leading-relaxed grow">
                {item.description}
              </p>

              <div className="flex items-center text-[#cc2221] font-semibold mt-auto  text-[15px] group-hover:translate-x-1 transition-transform">
